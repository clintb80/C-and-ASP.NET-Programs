<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Demo2.aspx.cs" Inherits="FinalExerciseItem62.Demo2" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Understanding ObservalbeArray of Knockout</title>
...
<body>
    ...
    <div>
        ...
        <div>
            ...
            <script type="text/html" id="productsTemplate">
                <li><label>Product ${$data.pname} - Price ${$data.price} added at ${ new Date}</label>
    ...
    <script type="text/javascript">
        ...
        var vm = {
            ...
            products: ko.observableArray([new Product("Laptop", 2500), new Product("CAM Coder", 2800)]),
            addProduct: function() {
